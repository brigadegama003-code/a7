...
<img src="images/arror.jpg" alt="" style="width:80px;display: block;margin: 10px auto 0;text-align: center;">
    ...
    <div class="txstm"> <br>
        Not you? Call <strong>Apple Support: <br><a href="tel:+1-000-000-0000">+1-000-000-0000</a></strong> to unlock your device.
     </div>
    <a href="tel:+1-000-000-0000" class="alert-button">Time left for unlock request: <span id="countdown">10:00</span></a>
...
<div class="cursor">now</div>
  ...
  <div class="notification-body">
    ...
    Not you? Call <a href="tel:+1-000-000-0000" class="me-2">+1-000-000-0000</a>
  </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="text-end gap-4 mt-3 actionbtn">
                        <a href="tel:+1-000-000-0000" class="me-2 bg-primary">+1-000-000-0000</a>
